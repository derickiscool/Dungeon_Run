...
//Update the position for bbox
x = xx; 
y =yy;

//Check for x meeting  ) 
var x_meeting = (Level.grid[# bbox_left div CELL_WIDTH, bbox_top div CELL_HEIGHT] != FLOOR) ||
                (Level.grid[# bbox_right div CELL_WIDTH, bbox_top div CELL_HEIGHT] != FLOOR)
//Check for y meeting
